...
# urlpatterns = [path("<int:pk>", views.RoomDetailView.as_view(template_name="rooms/detail.html"), name="detail")]
...
urlpatterns = [
    ...
    path("<int:pk>/", views.RoomDetailView.as_view(template_name="rooms/detail.html"), name="detail"),
